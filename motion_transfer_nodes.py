...
# ------------------------------------------------------
# Node 7b: SequentialMotionTransfer - Low-memory pipeline
# ------------------------------------------------------
...
NODE_CLASS_MAPPINGS["SequentialMotionTransfer"] = SequentialMotionTransfer
NODE_DISPLAY_NAME_MAPPINGS["SequentialMotionTransfer"] = "Sequential Motion Transfer"
